...
Textbox WhaleDongTxt = { Vector2D(40 - OVERLAY_OFFSETX, 190 - OVERLAY_OFFSETY), Vector2D(95 - OVERLAY_OFFSETX, 185 - OVERLAY_OFFSETY), Vector2D(95 - OVERLAY_OFFSETX, 200 - OVERLAY_OFFSETY), MENU_MISC, Centered, nullptr, 50, TYPES::Integer, WDresolverstr, 0.0, 64.0, "0", 0.0f, 0.0, 0, 0, IsNotFaded, IsNotDisabled };
...
void DrawMenu()
{
	...
	{
		//pSprite->Begin(D3DXSPRITE_ALPHABLEND | D3DXSPRITE_DO_NOT_ADDREF_TEXTURE);
		DecStr(privatebuildstr, 13);
		DrawStringUnencrypted(privatebuildstr, Vector2D(CenterX + (225 - OVERLAY_OFFSETX) + MenuOffsetXTxt.iValue, CenterY - (20 + OVERLAY_OFFSETY) - MenuOffsetYTxt.iValue), ColorRGBA(MenuTextLineColorRedTxt.flValue, MenuTextLineColorGreenTxt.flValue, MenuTextLineColorBlueTxt.flValue, 255), pFont);
		EncStr(privatebuildstr, 13);
		char LicStr[256];
